...
#define CE_PIN   9
#define CSN_PIN 10
#define PIPE 0xE8E8F0F0E1LL    //Define the transmit pipe
#define FDC B1010000    //FDC1004's address as a slave
...
uint16_t FDC_read(uint8_t u8Reg)    //read FDC1004 (REG)
{
  ...
  u16Data = (u8Temp1<<8)+u8Temp2;    //combine returning data
  return u16Data;
}
